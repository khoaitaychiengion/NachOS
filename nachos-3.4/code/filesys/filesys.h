...
class FileSystem {
  public:
	...
	OpenFile** openf;
	int index;
	int fileTableSize = 15;

	// redefine constructor
    FileSystem(bool format) {
		openf = new OpenFile*[fileTableSize];
		index = 0;
	...
	// Overload this function to open file for 2 dif types.
...
class FileSystem {
  public:
	...
	OpenFile* Open(char *name, int type); // Open file with type parameter
